...
#ifndef XALANTRANSFORM_HH_
#define XALANTRANSFORM_HH_

/**
 * The XalanTransform class is used in order to transform a XML document
 * with a XSLT stylesheet. The output file is also choosen.
 */
class XalanTransform {
  public:
     ...
     *
     */
	int transform(char *xml_filename, char *xsl_filename, char *out_filename);
	//@}
};

#endif /*XALANTRANSFORM_HH_*/
